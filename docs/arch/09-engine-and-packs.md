...
the bounded deterministic generated shrink matrix for PGO, Babysitter, Hider, Hunter, BackupInheritance, ConversionDeprogramming, MarkClearVisibility, PoisonCure, Ignite, ExtraAction, ItemGrant, PrivateNotification, Lovers, and
...
This row is trusted through the artifact classifier with `ok: true`, `family_count: 14`,
`case_count: 28`, `expected_family_count: 14`, `expected_case_count: 28`, and
