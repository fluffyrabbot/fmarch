...
the bounded deterministic generated shrink matrix for PGO, Babysitter, Hider, Hunter, BackupInheritance, ConversionDeprogramming, ConversionProjectionState, MarkClearVisibility, MarkClearExpiry, PoisonCure, Ignite, ExtraAction, ItemGrant, PrivateNotification, Lovers, and
...
This row is trusted through the artifact classifier with `ok: true`, `family_count: 16`,
`case_count: 32`, `expected_family_count: 16`, `expected_case_count: 32`, and
