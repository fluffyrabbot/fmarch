...
the bounded deterministic generated shrink matrix for PGO, Babysitter, Hider, Hunter, BackupInheritance, ConversionDeprogramming, Ignite, ExtraAction, ItemGrant, Lovers, and
...
This row is trusted through the artifact classifier with `ok: true`, `family_count: 11`,
`case_count: 22`, `expected_family_count: 11`, `expected_case_count: 22`, and
