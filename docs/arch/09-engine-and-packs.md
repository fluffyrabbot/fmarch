...
the bounded deterministic generated shrink matrix for PGO, Babysitter, Hider, Hunter, Ignite, ExtraAction, Lovers, and
...
This row is trusted through the artifact classifier with `ok: true`, `family_count: 8`,
`case_count: 16`, `expected_family_count: 8`, `expected_case_count: 16`, and
