...
the bounded deterministic generated shrink matrix for PGO, PgoProjectionState, Babysitter, Hider, Hunter, VengefulFixpoint, StrongmanVengefulFixpoint, BodyguardStrongmanVengefulFixpoint, BackupInheritance, BackupProjectionState, ConversionDeprogramming, ConversionProjectionState, MarkClearVisibility, MarkClearExpiry, PoisonCure, Ignite, ExtraAction, ItemGrant, PrivateNotification, Lovers, Bomb, and
...
This row is trusted through the artifact classifier with `ok: true`, `family_count: 22`,
`case_count: 44`, `expected_family_count: 22`, `expected_case_count: 44`, and
