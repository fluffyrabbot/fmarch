...
the bounded deterministic generated shrink matrix for PGO, Babysitter, Hider, Hunter, Ignite, Lovers, and
...
This row is trusted through the artifact classifier with `ok: true`, `family_count: 7`,
`case_count: 14`, `expected_family_count: 7`, `expected_case_count: 14`, and
