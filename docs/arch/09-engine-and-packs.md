...
the bounded deterministic generated shrink matrix for PGO, Babysitter, Hider, Hunter, BackupInheritance, ConversionDeprogramming, MarkClearVisibility, MarkClearExpiry, PoisonCure, Ignite, ExtraAction, ItemGrant, PrivateNotification, Lovers, and
...
This row is trusted through the artifact classifier with `ok: true`, `family_count: 15`,
`case_count: 30`, `expected_family_count: 15`, `expected_case_count: 30`, and
