...
the bounded deterministic generated shrink matrix for PGO, PgoProjectionState, Babysitter, Hider, HiderProjectionState, Hunter, VengefulFixpoint, StrongmanVengefulFixpoint, BodyguardStrongmanVengefulFixpoint, BackupInheritance, BackupProjectionState, ConversionDeprogramming, ConversionProjectionState, MarkClearVisibility, MarkClearExpiry, PoisonCure, Ignite, ExtraAction, ItemGrant, PrivateNotification, Lovers, Bomb, and
...
This row is trusted through the artifact classifier with `ok: true`, `family_count: 23`,
`case_count: 46`, `expected_family_count: 23`, `expected_case_count: 46`, and
