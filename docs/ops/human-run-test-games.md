...
verifying the twenty-seven hardening lane rows above.
...
concurrent vote race, stale player vote, stale player vote-after-change recovery, stale dead-target vote recovery,
