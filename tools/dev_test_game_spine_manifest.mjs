...
export function assertDevTestGameSpineManifest(manifest) {
  ...
  assertPlanScripts(coreLivePlan, [
    ...
    "tools/dev_test_game_host_decides_proof_contract.mjs",
    ...
    "tools/dev_test_game_host_decides_race_proof_contract.mjs",
  ...
  assertDevTestGameFullLiveArtifactPlanOrder({
    ...
    identityPlan: manifest.commands?.identity?.plan ?? [],
