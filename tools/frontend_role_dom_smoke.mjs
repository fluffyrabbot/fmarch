...
function surfaceScenarios() {
  return [
    ...
    },
    {
      ...
      requiredText: ["Full votecount", "Private queue", "Open events"],
      requiredTestIds: [
        "player-composer",
    ...
    },
    {
      ...
      requiredText: ["Host queue", "Votecount", "Select winner slots"],
      requiredTestIds: [
        "host-console-bar",
        ...
        "host-day-event-workspace-event-cookie",
        "day-event-winner-event-cookie-slot-1",
