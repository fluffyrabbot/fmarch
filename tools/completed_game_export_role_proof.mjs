...
if (!migrationUrl) throw new Error("DATABASE_MIGRATION_URL is required for completed-game export proof");
...
try {
  ...
  database = await scratch(migrationUrl);
