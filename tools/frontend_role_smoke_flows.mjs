...
export { createRoleMockState, mockStateProjections, fixtureApiRoutes } from "../frontend/src/lib/dev/role-fixtures.mjs";
  ...
  admin: Object.freeze({
    steps: Object.freeze([
      ...
      },
      {
        ...
        id: "confirmationGeometryBaseline",
        budgetRef: "interactionGeometryBudget.confirmation",
        label: "admin cohost confirmation",
      },
      ...
      { type: "set-from-value", from: { id: "cohostFocus" }, resultPath: "cohost.focus" },
      {
        type: "set-from-value",
        from: { id: "confirmationShot", path: "screenshot" },
        resultPath: "cohost.confirmationScreenshot",
      },
      {
        type: "set-from-value",
        from: { id: "confirmationShot", path: "pixels" },
        resultPath: "cohost.confirmationScreenshotPixels",
      },
