...
test("completed-game scenario module derives shared hardening lane groups", () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      {
        targetKey: "completedGameHostCompleteRace",
        featureSlotId: "completed-game-host-complete-race",
        roleUrlId: "concurrent-host-complete-race",
        checkpointId: "concurrent-host-complete-race",
        adminCheckId: "concurrent-host-complete-race",
        cycleId: "hardening-completed-game",
        role: "host",
      },
      {
        ...
        roleUrlId: "concurrent-host-complete-race-reload",
        checkpointId: "concurrent-host-complete-race-reload",
        adminCheckId: "concurrent-host-complete-race-reload",
        cycleId: "hardening-completed-game",
        role: "host",
      },
      {
        targetKey: "completedGamePlayerCompleteRace",
        featureSlotId: "completed-game-player-complete-race",
        roleUrlId: "concurrent-player-complete-race",
        checkpointId: "concurrent-player-complete-race",
        adminCheckId: "concurrent-player-complete-race",
        cycleId: "hardening-completed-game",
        role: "player",
      },
      {
        ...
        roleUrlId: "public-player-complete-reload",
        checkpointId: "public-player-complete-reload",
        adminCheckId: "public-player-complete-reload",
        cycleId: "hardening-completed-game",
        role: "player",
      },
      {
