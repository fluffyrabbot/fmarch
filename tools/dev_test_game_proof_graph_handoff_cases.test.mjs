...
test("admin proof destination handoff cases share link and audit rows", () => {
  ...
  assert.deepEqual(
    ...
    adminProofDestinationRequirementLinkRows.map(([linkId, auditId]) => ({
      linkId,
      auditId,
      roleUrl: `/_dev/ops/audit/${auditId}?game=<seeded-game>`,
    })),
  );
  assert.equal(
    adminProofDestinationRoleUrl({
    ...
    "/_dev/ops/audit/local-core-loop?game=midsummer",
  );
});
...
test("admin proof destination handoff cases derive proof graph nodes", () => {
  ...
  assert.deepEqual(
    ...
    adminProofDestinationRequirementLinkRows.map(([linkId, auditId]) => [
      ...
      `/_dev/ops/audit/${auditId}?game=midsummer`,
...
test("proof graph first-class fixture nodes share artifact and command contracts", () => {
  ...
  assert.deepEqual(
    ...
    [
      [
        ...
        "/_dev/ops/audit/local-admin-spine?game=midsummer",
        adminSpineProofCommand,
        [],
        [],
        [],
      ...
      [
        ...
        "/_dev/ops/audit/local-spine-manifest?game=midsummer",
        spineManifestAdminProofCommand,
        [],
        [],
        [],
      ...
      [
        ...
        "/_dev/ops/audit/local-proof-freshness?game=midsummer",
        proofFreshnessAdminProofCommand,
        [],
        [],
        [],
      ...
      [
        ...
        "/_dev/ops/audit/local-next-action?game=midsummer",
        nextActionCommand,
        [],
        [],
        [],
      ...
      [
        ...
        "passed",
        devTestGameHostedEvidenceLaneRealCaptureAdminProofPath,
        "/_dev/ops/audit/local-hosted-evidence-lane?game=midsummer",
        devTestGameHostedEvidenceLaneRealCaptureAdminProofCommand,
        [],
        [],
        [],
  ...
  assert.deepEqual(
    ...
    ),
    {
      ...
      roleUrl: "/_dev/ops/audit/local-core-loop?game=midsummer",
  ...
  assert.deepEqual(
    ...
    [
      ...
      })),
      {
        ...
        roleUrl: "/_dev/ops/audit/local-seed-fixtures?game=midsummer",
      ...
      },
      {
        ...
        roleUrl:
          "/_dev/ops/audit/local-real-hosted-observability-handoff?game=midsummer",
        status: "blocked",
