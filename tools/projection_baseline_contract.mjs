...
export const baselineSha256 = "1a1d9f4152cab814dd0e84817da08fbe9e09d928c2b2e14be58ec6b0a01014fd";
...
// The provider-session registry becomes the sole holder of the raw provider
// subject. This exact statement removes its duplicate from replay evidence;
// every other destructive migration statement remains forbidden.
const allowedWorkosSessionLifecycleSubjectRemovalSha256 =
...
function isAllowedSecurityMigrationStatement(file, statement) {
  if (file === workosSessionLifecycleMigration) {
    return createHash("sha256").update(statement).digest("hex") ===
      allowedWorkosSessionLifecycleSubjectRemovalSha256;
  }
