...
function demoScenarios({ roles, laneIds }) {
  ...
  return [
    ...
    scenario({
      ...
      note: "Seeded roles exercise stale replacement invite recovery, stale host invite retry recovery, duplicate replacement and post command retry, reconnect recovery, local vote/action and host resolve/advance/deadline-advance/lifecycle/complete-game/mixed-advance races, stale host phase/resolve/advance/publish/lifecycle/modkill/prompt/complete-game/deadline control rejection plus stale player completed-game command closure, and stale cohost deadline recovery.",
    }),
    scenario({
