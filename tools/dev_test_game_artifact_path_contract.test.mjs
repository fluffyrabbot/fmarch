...
const artifactPathPattern =
  /target\/(?:dev-test-game\/(?:ops-artifacts|seed-fixture-summary|race-coverage|race-coverage-admin-proof|hosted-concurrent-race-matrix|hosted-concurrent-race-matrix-admin-proof|hosted-target-preflight|hosted-target-preflight-admin-proof|hosted-evidence-lane|hosted-evidence-lane-admin-proof|hosted-evidence-lane-demo-proof|hosted-evidence-lane-operator-fixture|hosted-evidence-lane-operator-fixture-admin-proof|hosted-matrix-raw-evidence-fixture-proof|real-hosted-matrix-raw-capture|hosted-ops-signals|hosted-identity-evidence|hosted-identity-evidence-admin-proof|hosted-identity-progression-summary|real-hosted-observability-handoff|real-hosted-observability-handoff-admin-proof|release-runbook|release-runbook-admin-proof|release-admin-proof)\.json|auth-invite-role-proof\/invite-role-proof\.json|live-stack-backup-restore-drill\/(?:local-backup-restore-proof\.json|local-live-stack\.dump))/g;
