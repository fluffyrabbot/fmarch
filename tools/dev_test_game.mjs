  ...
  try {
    ...
    const d03R2RevotePromptActionId =
      d03R2RevotePrompt === null
        ? null
        : `resolve_host_prompt-${String(d03R2RevotePrompt.id).replace(
            /[^a-zA-Z0-9_-]+/g,
            "-",
          )}`;
