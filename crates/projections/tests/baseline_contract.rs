...
const EXPECTED_INDEXES: &[&str] = &[
    ...
    "auth_delivery_provider_attempt_fence_expiry_idx",
    "auth_delivery_provider_attempt_fence_pkey",
    "auth_delivery_provider_authority_one_active",
    "auth_delivery_provider_authority_pkey",
    ...
    "post_policy_pkey",
    "posting_budget_window_pkey",
    "posting_budget_window_updated_at_idx",
...
const EXPECTED_CONSTRAINTS: &[&str] = &[
    ...
    "auth_delivery_intent_claim_provenance_check:c",
    ...
    "auth_delivery_intent_provider_generation_fkey:f",
    "auth_delivery_intent_provider_id_check:c",
    "auth_delivery_intent_status_check:c",
    "auth_delivery_provider_attempt_fence_generation_fkey:f",
    "auth_delivery_provider_attempt_fence_pkey:p",
    "auth_delivery_provider_attempt_fence_time_check:c",
    "auth_delivery_provider_authority_circuit_version_check:c",
    "auth_delivery_provider_authority_fingerprint_check:c",
    "auth_delivery_provider_authority_generation_check:c",
    "auth_delivery_provider_authority_lifecycle_check:c",
    "auth_delivery_provider_authority_pkey:p",
    "auth_delivery_provider_authority_probe_check:c",
    "auth_delivery_provider_authority_time_check:c",
    ...
    "discussion_post_edited_check:c",
    "discussion_post_pkey:p",
    "discussion_post_revision_check:c",
    "discussion_post_revision_pkey:p",
    "discussion_post_revision_revision_check:c",
    "discussion_post_revision_source_seq_fkey:f",
    ...
    "post_policy_pkey:p",
    "posting_budget_window_budget_check:c",
    "posting_budget_window_clock_check:c",
    "posting_budget_window_pkey:p",
    "posting_budget_window_used_check:c",
