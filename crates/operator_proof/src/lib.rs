...
pub fn build_operator_large_action_graph_performance_report(
    artifact_path: impl Into<String>,
    proof: commands::LargeActionGraphPerformanceProof,
...
mod tests {
    ...
    fn resolution_diff_report_summarizes_and_classifies() {
        ...
        let report = build_operator_resolution_diff_report(
            ...
            commands::ResolutionEnvelopeAuditReport {
                game_id: game,
                ok: false,
                audited: 2,
                skipped: 1,
                summary: commands::ResolutionEnvelopeAuditSummary {
                    matched: 1,
                    drifted: 1,
                    skipped: 1,
                ...
                phases: vec![
                    commands::ResolutionEnvelopeAuditPhase {
                        ...
                        status: commands::ResolutionEnvelopeAuditStatus::Matched,
                    ...
                    commands::ResolutionEnvelopeAuditPhase {
                        ...
                        status: commands::ResolutionEnvelopeAuditStatus::Drifted,
                        applied_matches: false,
                        trace_matches: true,
                        reason: Some("fixture drift".to_string()),
                        diffs: vec![commands::ResolutionEnvelopeAuditDiff {
                            envelope: commands::ResolutionEnvelopeAuditEnvelope::Applied,
                            path: "$.events[0]".to_string(),
        ...
        let report = build_operator_trace_inspection_report(
            ...
            commands::ResolutionTraceInspectionReport {
                ...
                traces: vec![commands::ResolutionTraceInspectionRun {
                    ...
                    trace_stream_seq: 11,
                    trace_version: 1,
                    decisions: vec![commands::ResolutionTraceDecisionRow {
                        row_index: 0,
                        applied_stream_seq: Some(10),
                        event_index: Some(0),
                    ...
                    edges: vec![commands::ResolutionTraceEdgeRow {
                        row_index: 0,
                        applied_stream_seq: Some(10),
                    ...
                    generated: vec![commands::ResolutionTraceGeneratedRow {
                        row_index: 0,
                        applied_stream_seq: Some(10),
                    ...
                    effect_changes: vec![commands::ResolutionTraceEffectChangeRow {
                        row_index: 0,
                        applied_stream_seq: Some(10),
                    ...
                    visibility: Vec::new(),
                    notes: vec![commands::ResolutionTraceNoteRow {
                        row_index: 0,
                        applied_stream_seq: Some(10),
    ...
    fn determinism_fuzz_report_summarizes_and_classifies() {
        ...
        let report = build_operator_determinism_fuzz_report(
            ...
            "RUST_MIN_STACK=8388608 DATABASE_URL=postgres://fmarch:fmarch@localhost:5544/fmarch cargo test -p commands --test pipeline replay_audit_and_rebuild_deterministically -- --ignored --nocapture",
    ...
    fn large_action_graph_performance_report_summarizes_and_classifies() {
        ...
        match proof_run_large_action_graph_performance_report_artifact_state_at(
            ...
            ProofRunArtifactState::LargeActionGraphPerformanceReportPresent {
                ...
                assert_eq!(
                    threshold_ms,
                    commands::LARGE_ACTION_GRAPH_PERFORMANCE_THRESHOLD_MS
                );
