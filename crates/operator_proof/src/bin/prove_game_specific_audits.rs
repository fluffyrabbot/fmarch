...
mod tests {
    ...
    fn actual_manifest_expands_three_game_specific_commands() {
        ...
        assert!(commands
            .iter()
            .any(|command| command.contains("cargo run -p operator_proof --bin audit_resolution")));
        assert!(commands
            .iter()
            .any(|command| command.contains("cargo run -p operator_proof --bin inspect_trace")));
    }
    ...
    fn normalizes_expected_retention_drift() {
        let old = json!({
            ...
            "runs": [{
                ...
                "command": "DATABASE_URL=db cargo run -p operator_proof --bin audit_resolution -- 11111111-1111-1111-1111-111111111111",
                "ok": true,
                "summary": {
                    "game_id": "11111111-1111-1111-1111-111111111111",
                    "phases": [{
        ...
        let new = json!({
            ...
            "runs": [{
                "id": "resolution-replay-audit",
                "command": "DATABASE_URL=db cargo run -p operator_proof --bin audit_resolution -- 22222222-2222-2222-2222-222222222222",
                "ok": true,
                "summary": {
                    "game_id": "22222222-2222-2222-2222-222222222222",
                    "phases": [{
