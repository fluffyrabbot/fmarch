...
async fn vertical_operator_index_is_host_audit_only(pool: sqlx::PgPool) {
    ...
    assert!(generated_shrink_go_no_go_html.contains("family_count: 16"));
    assert!(generated_shrink_go_no_go_html.contains("case_count: 32"));
    assert!(generated_shrink_go_no_go_html.contains("expected_family_count: 16"));
    assert!(generated_shrink_go_no_go_html.contains("expected_case_count: 32"));
