...
pub static MIGRATOR: sqlx::migrate::Migrator = sqlx::migrate!("../projections/migrations");

/// Fail closed unless the dedicated migrator has applied this binary's complete schema set.
/// This is a read-only readiness assertion; ordinary API startup never changes schema state.
