...
const REPLACEMENT_EVENT = Object.freeze({
  ...
  payload: Object.freeze({
    ...
    gameId: "00000000-0000-0000-0000-000000000001",
    slotId: "slot-7",
    outgoingPersonaId: "00000000-0000-0000-0000-000000000007",
...
test("host actions map to generated wire command variants", () => {
  ...
  assert.deepEqual(mapHostActionToWireCommand(REPLACEMENT_EVENT), {
    ProcessReplacement: {
      game: "00000000-0000-0000-0000-000000000001",
      slot: "slot-7",
      outgoing_persona_id: "00000000-0000-0000-0000-000000000007",
        ...
        slots: [
          {
            ...
            persona_id: "gp-rowan",
            public_name: "Rowan",
            assigned_principal_id: "player-rowan",
            alive: false,
            status: "modkilled",
          },
        ],
        thread_posts: [{ author: { kind: "slot", slot_id: "slot-7" }, body: "before replacement" }],
      });
    },
  });
  ...
  const snapshot = projectHostConsoleState(
    {
      ...
      thread_posts: [{ stream_seq: 10, author: { kind: "slot", slot_id: "slot-7" }, body: "hello" }],
      tasks: [],
    },
    {
