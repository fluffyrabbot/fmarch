...
export type ThreadPost = { game: string, source_seq: bigint, stream_seq: bigint, channel_id: string, author_slot: string | null, author_user: string | null, phase_id: string, body: string, media: Array<ThreadPostMedia>, quotations: Array<Quotation>, citation_count: bigint, occurred_at: bigint, };
