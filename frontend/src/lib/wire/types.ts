...
export type HostConsoleSlotOccupancyDelta = { slot_id: string, occupancy_id: string, persona_id: string, public_name: string, assigned_principal_id: string, alive: boolean, status: string, status_tags: Array<string>, role_key: string | null, alignment: string | null, role_revealed: boolean, alignment_revealed: boolean, };
