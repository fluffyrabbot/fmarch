...
export type SubmitPostMention = { slot_id: string, offset: bigint, len: bigint, };

export type SubmitPostEmbed = { url: string, };
...
export type PostRef = { kind: PostKind, scope_id: string, source_seq: bigint, };

export type Quotation = { target: PostRef, excerpt: string, };

export type PostCitation = { quoting: PostRef, occurred_at: bigint, };
 ...
 */
day_event_scheduler: DayEventSchedulerDelta | null,
/**
...
export type PublicContentRef = { surface_id: string, source_seq: bigint, };

export type GameOriginTopic = { topic: string, title: string, href: string, };

export type SpawnedGame = { game: string, pack: string, status: string, href: string, };

export type GameIndexEntry = { game: string, pack: string, status: string, phase_id: PhaseId | null, updated_seq: bigint, completed_seq: bigint | null, origin_topic: GameOriginTopic | null, };
 ...
 */
pinned: boolean, spawned_games: Array<SpawnedGame>, };
