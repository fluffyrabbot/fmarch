...
test("command proxy binds browser commands to the opaque session cookie", async () => {
  ...
  try {
    const envelope = { v: 3, id: 7, body: { kind: "Command", body: { command_id: "00000000-0000-0000-0000-000000000007", command: { AddSlot: { game: "00000000-0000-0000-0000-000000000001", slot: "slot_1" } } } } };
    const observed = {};
    const response = await POST({
      ...
      fetch: async (url, init) => {
        ...
        return Response.json({ v: 3, id: 7, body: { kind: "Ack", body: { stream_seqs: [2] } } });
      },
    });
