...
<main class="fm-surface auth-register" data-testid="auth-registration-classic-surface">
  <section class="fm-surface__masthead">
    <div>
      <p class="fm-eyebrow">Account</p>
      <h1>Create account</h1>
      <p class="fm-summary">Create a classic account with a password. Your credentials and sessions stay on this server; no third-party identity provider is contacted.</p>
    </div>
  </section>
